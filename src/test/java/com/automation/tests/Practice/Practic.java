...
public class Practic {
    ...
    @Test
    public void verifylastnameLeter(){
        driver.findElement(lastNameBy).sendKeys("w");
        WebElement warninLast=driver.findElement(By.xpath("//small[text()='The last name must be more than 2 and less than 64 characters long']"));
        BrowserUtils.wait(3);
     Assert.assertTrue(warninLast.isDisplayed());
    }
    @Test
    public void verifylastBynumber(){
        driver.findElement(lastNameBy).sendKeys("1");
        WebElement warninNum=driver.findElement(By.xpath("//small[text()='The last name can only consist of alphabetical letters and dash']"));
        BrowserUtils.wait(3);
        Assert.assertTrue(warninNum.isDisplayed());


    }
    @Test
    public void verifyUsernameByAlphabet(){
        driver.findElement(userNameBy).sendKeys("b");
        WebElement warningLet=driver.findElement(By.xpath("//small[text()='The last name must be more than 2 and less than 64 characters long']"));
        BrowserUtils.wait(3);
        Assert.assertTrue(warningLet.isDisplayed());
    }
