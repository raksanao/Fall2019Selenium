package com.automation.tests.vyTruck.login;
...
//http - data as a plain text, very easy to hack it
    ...
    public void invalidUsername() {
        driver.findElement(usernameBy).sendKeys("sinvalidusername");
...
public void loginAsStoremanager(){
    ...
    assertEquals(actual,expected,"Page is title not correct");
}
    @BeforeMethod
    public void setup() {
